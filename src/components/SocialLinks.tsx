...
export default async function SocialLinks() {
  ...
  try {
    ...
    // تجاهل الأخطاء - سنستخدم القيم الافتراضية
  }

  // إذا لم توجد إعدادات، استخدم قيم افتراضية (للعرض الأول)
  const defaults = {
  ...
  const socials = [
    {
      name: "facebook",
      label: "فيسبوك",
      url: settings?.facebook || defaults.facebook,
    ...
    },
    {
      name: "instagram",
      label: "إنستغرام",
      url: settings?.instagram || defaults.instagram,
    ...
    },
    {
      name: "youtube",
      label: "يوتيوب",
      url: settings?.youtube || defaults.youtube,
    ...
    },
    {
      name: "tiktok",
      label: "تيك توك",
      url: settings?.tiktok || defaults.tiktok,
    ...
    },
    {
      name: "whatsapp",
      label: "واتساب",
      url: settings?.whatsapp ? `https://wa.me/${String(settings.whatsapp).replace(/[^0-9]/g, "")}` : `https://wa.me/${defaults.whatsapp}`,
    ...
    },
    {
      name: "twitter",
      label: "إكس",
      url: settings?.twitter || defaults.twitter,
    ...
    <div className="flex items-center justify-center gap-3 mb-6">
      {socials.map((social) => (
        <a
          ...
          className="group w-11 h-11 rounded-full bg-white dark:bg-[#1a1a1a] border-2 border-[#D4AF37]/40 hover:border-[#D4AF37] flex items-center justify-center text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#111] hover:shadow-lg hover:shadow-[#D4AF37]/40 hover:scale-110 transition-all duration-300"

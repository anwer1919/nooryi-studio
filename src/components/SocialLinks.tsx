...
export default async function SocialLinks() {
  ...
  const socials = [
    { name: "facebook", icon: FacebookIcon, url: settings?.facebook, color: "hover:text-blue-500" },
    { name: "instagram", icon: InstagramIcon, url: settings?.instagram, color: "hover:text-pink-500" },
    { name: "youtube", icon: YoutubeIcon, url: settings?.youtube, color: "hover:text-red-500" },
    { name: "tiktok", icon: TiktokIcon, url: settings?.tiktok, color: "hover:text-white" },

          ...
          <div style={{ maxHeight: "400px", overflowY: "auto", padding: "var(--space-2)" }}>
            {notifications.length === 0 ? (
              <div style={{ padding: "var(--space-10) var(--space-4)", textAlign: "center" }}>
                <Bell size={40} style={{ color: "var(--color-text-tertiary)", margin: "0 auto 12px", opacity: 0.5 }} />
                <p style={{ fontSize: "var(--text-sm)", color: "var(--color-text-secondary)", margin: 0 }}>لا توجد إشعارات</p>
              </div>
            ) : (

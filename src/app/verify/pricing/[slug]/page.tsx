    ...
    return (
      <div dir="rtl" className="min-h-screen bg-gradient-to-br from-red-50 to-white flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md text-center border-2 border-red-200">
          ...
          <p className="text-muted mb-6">لم يتم العثور على الفنان المطلوب</p>
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gradient-to-br from-[#faf8f0] to-white py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-bg to-[#111] rounded-2xl p-8 text-fg mb-6 shadow-2xl">
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-muted uppercase tracking-wider">تقرير أسعار</p>
              <h2 className="text-3xl font-black mt-1">{artist.name}</h2>
              <p className="text-sm text-muted mt-1">{artist.category || "فنان"}</p>
            </div>
            <div className="text-right">
              <p className="text-xs text-muted">رقم التقرير</p>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-white rounded-2xl p-6 border-2 border-[#F5A623] shadow-lg">
            <p className="text-xs text-muted font-bold uppercase mb-2">عدد المناطق</p>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow">
            <p className="text-xs text-muted font-bold uppercase mb-2">متوسط السعر</p>
            <p className="text-3xl font-black text-[#F5A623]">{avgPrice.toLocaleString()}</p>
            <p className="text-xs text-muted mt-1">ج.م</p>
          </div>
          <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow">
            <p className="text-xs text-muted font-bold uppercase mb-2">تاريخ التحقق</p>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 mb-6">
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-3 text-right text-xs font-black text-muted uppercase">#</th>
                <th className="px-6 py-3 text-right text-xs font-black text-muted uppercase">المنطقة</th>
                <th className="px-6 py-3 text-center text-xs font-black text-muted uppercase">السعر الأساسي</th>
                <th className="px-6 py-3 text-center text-xs font-black text-muted uppercase">رسوم السفر</th>
                <th className="px-6 py-3 text-center text-xs font-black text-muted uppercase">الإجمالي</th>
              </tr>
            </thead>
            <tbody>
        ...
        {/* Official Notice */}
        <div className="bg-bg rounded-2xl p-6 text-fg text-center">

        ...
        <div className="text-center mb-6">
          <Link href="/" className="inline-flex items-center gap-3">
            ...
            <div className="text-right">
              <p className="text-lg font-black text-fg">Nooryi</p>
              <p className="text-[9px] text-[#F5A623] font-bold tracking-[0.2em] uppercase">Studio</p>
            </div>
          </Link>
        </div>
        <div className="bg-surface border border-[#F5A623]/15 rounded-2xl p-6">
          <Suspense fallback={<div className="py-12 text-center text-muted">جاري التحميل...</div>}>

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "احجز أفضل الفنانين والموسيقيين لحفلاتك ومناسباتك الخاصة.",
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "Nooryi Studio" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Nooryi Studio | منصة حجز الفنانين الأولى",
    description: "احجز أفضل الفنانين والموسيقيين لحفلاتك ومناسباتك الخاصة.",
    images: ["/og-image.jpg"], creator: "@nooryi_studio",
  },
  ...
  other: { "apple-mobile-web-app-capable": "yes", "apple-mobile-web-app-status-bar-style": "black-translucent", "apple-mobile-web-app-title": "Nooryi" },
};

export const viewport: Viewport = {
  width: "device-width", initialScale: 1, maximumScale: 5, userScalable: true,
  themeColor: [{ media: "(prefers-color-scheme: light)", color: "#faf8f0" }, { media: "(prefers-color-scheme: dark)", color: "#0a0a0a" }],
  ...
  return (
    <html lang="ar" dir="rtl" className="dark" suppressHydrationWarning>
      <head>
        ...
        <style dangerouslySetInnerHTML={{ __html: `html { color-scheme: dark; } body { background-color: #0a0a0a; }` }} />
      </head>

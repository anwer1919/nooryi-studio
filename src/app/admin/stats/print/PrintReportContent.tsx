...
export default function PrintReportContent() {
  ...
  const reportDate = new Date().toLocaleDateString("ar-EG", { year: "numeric", month: "long", day: "numeric", timeZone: "UTC" , timeZone: "UTC"}))
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="md:text-left">
            <div className="inline-grid grid-cols-2 gap-x-8 gap-y-3 text-sm">
              ...
              <span className="font-bold text-black">{from ? new Date(from).toLocaleDateString("ar-EG", { timeZone: "UTC" , timeZone: "UTC"})) : "البداية"}</span>
              <span className="text-gray-500">إلى تاريخ:</span>
              <span className="font-bold text-black">{to ? new Date(to).toLocaleDateString("ar-EG", { timeZone: "UTC" , timeZone: "UTC"})) : "الآن"}</span>

    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-black border-t-[#F5A623] rounded-full animate-spin mx-auto mb-4"></div>
    ...
    <div dir="rtl" className="min-h-screen bg-gray-100 p-4 md:p-8 font-sans">
      ...
      <div className="no-print max-w-[210mm] mx-auto mb-6 bg-white p-6 rounded-2xl shadow-lg border-2 border-black">
        <h3 className="font-bold text-black mb-4 flex items-center gap-2">
          <Filter size={20} className="text-[#F5A623]" /> فلاتر متقدمة
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">حالة الحجز:</label>
            <select value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)} className="w-full p-3 border-2 border-black rounded-lg font-semibold focus:outline-none focus:border-[#F5A623]">
          ...
          <div>
            ...
            <select value={paymentFilter} onChange={(e) => setPaymentFilter(e.target.value)} className="w-full p-3 border-2 border-black rounded-lg font-semibold focus:outline-none focus:border-[#F5A623]">
          ...
          <div>
            ...
            <select value={artistFilter} onChange={(e) => setArtistFilter(e.target.value)} className="w-full p-3 border-2 border-black rounded-lg font-semibold focus:outline-none focus:border-[#F5A623]">
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex flex-col items-end gap-3">
              <div className="bg-black px-8 py-4 rounded-lg shadow-2xl">
                <h2 className="text-2xl font-black text-[#F5A623] uppercase tracking-[0.2em]">تقرير مالي شامل</h2>
              </div>
              {reportNumber && (

    ...
    <div dir="rtl" className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-black text-white">الإشعارات</h1>
          <p className="text-gray-400 text-sm mt-1">{unreadCount > 0 ? `${unreadCount} إشعار غير مقروء` : "كل الإشعارات مقروءة"}</p>
        </div>
        {unreadCount > 0 && (
          <form action={async () => {
            "use server"

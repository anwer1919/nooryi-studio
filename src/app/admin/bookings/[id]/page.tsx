        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div className="bg-[#111] p-6 rounded-2xl shadow-sm border border-[#D4AF37]/20">
            ...
            <div className="space-y-3">
              <div><p className="text-xs text-gray-500 font-semibold mb-1">الاسم</p><p className="font-bold text-white">{clientName}</p></div>
              {booking.clientEmail && <div className="flex items-center gap-2"><Mail size={16} className="text-gray-400" /><p className="text-sm text-gray-300">{booking.clientEmail}</p></div>}
              {booking.clientPhone && <div className="flex items-center gap-2"><Phone size={16} className="text-gray-400" /><p className="text-sm text-gray-300" dir="ltr">{booking.clientPhone}</p></div>}
            </div>
          </div>
          ...
          <div className="bg-[#111] p-6 rounded-2xl shadow-sm border border-[#D4AF37]/20">
            <div className="flex items-center gap-3 mb-4 pb-4 border-b border-[#D4AF37]/20">
              ...
              <h3 className="font-bold text-white text-lg">الفنان</h3>
            </div>
            {booking.artist ? (
          ...
          <div className="bg-[#111] p-6 rounded-2xl shadow-sm border border-[#D4AF37]/20">
            <div className="flex items-center gap-3 mb-4 pb-4 border-b border-[#D4AF37]/20">
              ...
              <h3 className="font-bold text-white text-lg">مكان الفعالية</h3>
            </div>
            {booking.venue ? (
              <div className="space-y-3">
                <div><p className="text-xs text-gray-500 font-semibold mb-1">اسم المكان</p><p className="font-bold text-white">{booking.venue.name}</p></div>
                {booking.venue.address && <div><p className="text-xs text-gray-500 font-semibold mb-1">العنوان</p><p className="text-sm text-gray-300">{booking.venue.address}</p></div>}
              </div>
            ) : <p className="text-gray-500 italic">لا توجد معلومات</p>}
          </div>
        </div>

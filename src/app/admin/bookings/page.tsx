        ...
        {bookings.length === 0 ? (
          ...
          <div className="space-y-4">
            {bookings.map((booking) => {
              ...
              const detailsUrl = `/admin/bookings/${booking.id}`
                ...
                >
                  <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-[150px]">
                      <p className="text-xs text-white/40 mb-1">المبلغ</p>
                  ...
                  {/* ID and Links Section */}
                  <div className="pt-4 border-t border-white/5 flex flex-wrap items-center gap-3">
                    <div className="flex items-center gap-2 flex-1 min-w-[300px]">
                      <code className="text-xs bg-white/5 px-3 py-1.5 rounded-lg text-white/60 font-mono">
                        {booking.id}
                      </code>
                      <button
                        onClick={() => {
                    ...
                    <div className="flex gap-2">
                      ...
                      <a
                        ...
                        className="flex items-center gap-2 px-3 py-2 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm hover:bg-blue-500/20 transition-all"

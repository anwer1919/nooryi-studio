        ...
        <div className="bg-white dark:bg-[#111] rounded-2xl border overflow-hidden no-print">
          <div className="bg-gradient-to-r from-[#0a0a0a] to-[#111] p-6 text-white">
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="text-right"><p className="text-xs text-gray-400">حجوزات هذا الشهر</p><p className="text-3xl font-black text-[#F5A623]">{monthBookings.length}</p></div>
            </div>
          </div>
        ...
        <div id="print-report">
          ...
          <div className="px-10 pt-6 pb-4 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] text-white">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                ...
                <div><h1 className="text-3xl font-black">{STUDIO_INFO.nameAr}</h1><p className="text-[#F5A623] font-bold">{STUDIO_INFO.name}</p><p className="text-xs text-gray-400 mt-1">{STUDIO_INFO.tagline}</p></div>
              </div>
              <div className="text-right"><div className="inline-block px-4 py-2 bg-[#F5A623]/20 border border-[#F5A623] rounded-lg"><p className="text-xs text-[#F5A623] font-bold">تقرير تقويم الحجوزات</p><p className="text-xs text-gray-300 font-mono mt-1" dir="ltr">{reportId}</p></div></div>
            </div>
          ...
          <div className="px-10 py-4 bg-[#faf8f0] border-b-4 border-[#F5A623] flex items-center justify-between">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="text-center"><p className="text-xs text-gray-500">الإيرادات</p><p className="text-lg font-black text-[#F5A623]">{totalRevenue.toLocaleString()}</p><p className="text-[10px] text-gray-400">ج.م</p></div>
          ...
          <div className="px-10 py-4">
            ...
            {monthBookings.length === 0 ? <div className="py-12 text-center text-gray-400"><p>لا توجد حجوزات في هذا الشهر</p></div> : (
              <table className="w-full border-collapse">
                ...
                <tfoot><tr className="bg-[#1a1a1a] text-white font-black"><td colSpan={6} className="px-3 py-2 text-right">الإجمالي</td><td className="px-3 py-2 text-center text-[#F5A623]">{totalRevenue.toLocaleString()} ج.م</td><td></td></tr></tfoot>
              </table>
            )}
          </div>
          <div className="px-10 py-6 bg-gradient-to-b from-white to-[#faf8f0] border-t border-gray-200">
            <div className="grid grid-cols-3 gap-6 items-center">
              ...
              <div className="flex flex-col items-center justify-center"><div className="relative"><div className="w-28 h-28 rounded-full border-4 border-[#F5A623] flex items-center justify-center" style={{ transform: 'rotate(-15deg)', boxShadow: 'inset 0 0 0 2px #F5A623, 0 0 0 2px #F5A623' }}><div className="text-center"><p className="text-[7px] font-bold text-[#F5A623] uppercase tracking-widest">{STUDIO_INFO.name}</p><p className="text-xs font-black text-[#F5A623] my-1">✦ معتمد ✦</p><p className="text-[9px] font-black text-[#F5A623]">APPROVED</p></div></div><div className="absolute inset-0 rounded-full border-2 border-[#F5A623]" style={{ transform: 'rotate(-15deg) scale(1.15)', opacity: 0.5 }}></div></div><p className="text-[9px] text-gray-500 mt-2 font-bold uppercase tracking-widest">ختم المنصة الرسمي</p></div>
              <div className="flex flex-col items-center"><div className="bg-white p-2 rounded-xl border-2 border-[#F5A623] shadow-lg"><QRCode value={verifyUrl} size={90} level="H" bgColor="#FFFFFF" fgColor="#0a0a0a" /></div><p className="text-[9px] text-gray-500 mt-2 font-bold uppercase tracking-wider">امسح للتحقق</p></div>
            </div>
            <div className="mt-4 h-0.5 bg-gradient-to-r from-transparent via-[#F5A623] to-transparent"></div>
          ...
          <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm overflow-y-auto no-print">
            <div className="sticky top-0 z-10 bg-gradient-to-r from-[#0a0a0a] to-[#111] border-b border-[#F5A623]/30">
              <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
                <div className="flex items-center gap-3"><Eye size={20} className="text-[#F5A623]" /><h2 className="text-xl font-black text-white">معاينة تقرير التقويم</h2></div>
            ...
            <div className="max-w-5xl mx-auto py-8 px-4">
              <div className="bg-white rounded-lg shadow-2xl overflow-hidden" style={{ aspectRatio: '297/210' }}>
                ...
                <div className="px-8 pt-6 pb-4 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] text-white"><div className="flex items-center gap-4"><div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#F5A623] to-[#E8961A] flex items-center justify-center"><span className="text-[#111] text-2xl font-black">N</span></div><div><h1 className="text-2xl font-black">{STUDIO_INFO.nameAr}</h1><p className="text-[#F5A623] font-bold text-sm">{STUDIO_INFO.name}</p></div></div></div>
                <div className="px-8 py-4 bg-[#faf8f0] border-b-4 border-[#F5A623]"><h2 className="text-xl font-black">{artist.name} — {monthName}</h2><p className="text-sm text-gray-600">تقرير تقويم الحجوزات — رقم: <span className="font-mono" dir="ltr">{reportId}</span></p></div>
                <div className="px-8 py-4"><p className="text-sm text-gray-600 mb-2">عدد الحجوزات: <strong>{monthBookings.length}</strong> — إجمالي الإيرادات: <strong className="text-[#F5A623]">{totalRevenue.toLocaleString()} ج.م</strong></p></div>
                <div className="px-8 py-4 bg-gradient-to-b from-white to-[#faf8f0]"><div className="grid grid-cols-3 gap-4 items-center"><div className="text-xs text-gray-600"><p className="font-bold">تواصل معنا:</p><p>{STUDIO_INFO.phone}</p><p>{STUDIO_INFO.email}</p></div><div className="flex flex-col items-center"><div className="w-16 h-16 rounded-full border-4 border-[#F5A623] flex items-center justify-center" style={{ transform: 'rotate(-15deg)' }}><p className="text-[8px] font-black text-[#F5A623]">✦ معتمد ✦</p></div></div><div className="flex flex-col items-center"><div className="bg-white p-1 rounded border-2 border-[#F5A623]"><QRCode value={verifyUrl} size={60} level="H" /></div><p className="text-[9px] text-gray-500 mt-1">امسح للتحقق</p></div></div></div>
                <div className="h-2 bg-gradient-to-r from-[#F5A623] via-[#FFC966] to-[#F5A623]"></div>
              </div>

      ...
      <div className="card-pro overflow-hidden print-area">
        <div className="grid grid-cols-7">
          ...
          {days.map((day,i)=>{
            ...
            return <button key={k} onClick={()=>setSel(isel?null:k)} className={"aspect-square flex flex-col items-center justify-center relative border border-gray-100 transition-all hover:bg-gray-50 "+(ib?"bg-red-50":"bg-white")+(it?" ring-2 ring-[#F5A623] ring-inset":"")+(isel?" ring-2 ring-[#111] ring-inset":"")}>
              <span className={"text-lg font-black "+(ib?"text-red-600":it?"text-[#E8961A]":"text-gray-700")}>{day.getDate()}</span>

...
export default async function InvoicePage({
    ...
    return (
      <div dir="rtl" className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-xl font-bold text-muted mb-4">معرف الحجز غير موجود</p>
          <Link href="/my-bookings" className="text-[#F5A623] hover:underline">العودة لحجوزاتي</Link>
        </div>
      </div>
    )
  }
  ...
  if (!booking) {
    return (
      <div dir="rtl" className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-xl font-bold text-muted mb-4">الحجز غير موجود</p>
          <Link href="/my-bookings" className="text-[#F5A623] hover:underline">العودة لحجوزاتي</Link>
        </div>
      </div>
    )

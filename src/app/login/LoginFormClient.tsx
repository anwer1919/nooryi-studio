...
import { Mail, Lock, Loader2, Eye, EyeOff, Sparkles, ShieldCheck, Star, CalendarCheck, Music, Smartphone, Globe } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-md py-8">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <button onClick={() => signIn("google", { callbackUrl })} className="flex items-center justify-center gap-3 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all font-semibold text-sm cursor-pointer">
        ...
        <button disabled className="flex items-center justify-center gap-3 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-400 font-semibold text-sm cursor-not-allowed opacity-60">

      ...
      <div className="w-full max-w-md py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">
            تم إرسال رمز التحقق إلى <span className="font-bold text-gray-800">{otpInfo?.destination}</span>
          </p>
        </div>
      ...
      <form onSubmit={handleCredentialsSubmit} className="space-y-4">
        <div>
          ...
          <div className="relative">
            ...
            <input type="email" required value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} className="w-full pr-10 pl-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#d4af37] outline-none transition-all text-gray-900 placeholder:text-gray-400" placeholder="example@email.com" />
          </div>
        </div>
        <div>
          ...
          <div className="relative">
            ...
            <input type={showPassword ? "text" : "password"} required value={formData.password} onChange={e => setFormData({ ...formData, password: e.target.value })} className="w-full pr-10 pl-10 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#d4af37] outline-none transition-all text-gray-900 placeholder:text-gray-400" placeholder="••••••••" />

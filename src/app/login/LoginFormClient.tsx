  ...
  return (
    <div className="w-full max-w-md py-8">
      ...
      <div className="relative flex items-center py-5 mt-2">
        ...
        <span className="flex-shrink mx-4 text-gray-400 dark:text-gray-500 text-xs font-semibold">أو تابع عبر</span>
        <div className="flex-grow border-t border-gray-200 dark:border-white/10"></div>
      </div>

      <div className="space-y-3">
        <button onClick={() => handleSocialLogin("google")} disabled={loading} className="w-full flex items-center justify-center gap-3 py-3.5 bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-white/10 rounded-xl hover:bg-gray-50 dark:hover:bg-[#222] hover:border-gray-300 dark:hover:border-white/20 hover:shadow-md transition-all cursor-pointer group disabled:opacity-50">
          ...
          <span className="text-sm font-bold text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white">Google</span>
        </button>
        <button onClick={() => handleSocialLogin("apple")} disabled={loading} className="w-full flex items-center justify-center gap-3 py-3.5 bg-[#000] border border-[#333] dark:border-white/10 rounded-xl hover:bg-[#1a1a1a] hover:shadow-md transition-all cursor-pointer group disabled:opacity-50">
          ...
          <span className="text-sm font-bold text-white group-hover:text-gray-200">Apple</span>
        </button>
      </div>
    </div>
  );

          ...
          <div className="mb-6 no-print">
            <div className="bg-green-50 border-2 border-green-200 rounded-2xl p-4 flex items-center gap-3 mb-4">
              ...
              <div className="flex-1">
                <p className="font-bold text-green-800 text-lg">فاتورة معتمدة ✓</p>
            ...
            <div className="bg-[#faf8f0] border-b-2 border-[#D4AF37]/30 px-6 md:px-8 py-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <p className="text-sm md:text-base font-bold text-gray-900 truncate">{booking.artist?.name || "-"}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 font-semibold mb-1">الفئة</p>
                  <p className="text-sm md:text-base font-bold text-gray-900 truncate">{booking.artist?.category || "-"}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 font-semibold mb-1">العميل</p>
                  <p className="text-sm md:text-base font-bold text-gray-900 truncate">{booking.clientName}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 font-semibold mb-1">الهاتف</p>
                  <p className="text-sm md:text-base font-bold text-gray-900" dir="ltr">{booking.clientPhone}</p>
                </div>
              </div>
            </div>
